...
#ifdef USE_STAROS
        _config_callback.emplace("starlet_use_star_cache", [&]() {
            update_staros_starcache();
        });
        _config_callback.emplace("starlet_star_cache_mem_size_percent", [&]() {
            update_staros_starcache();
        });
        _config_callback.emplace("starlet_star_cache_disk_size_percent", [&]() {
            update_staros_starcache();
        });
        _config_callback.emplace("starlet_star_cache_disk_size_bytes", [&]() {
            update_staros_starcache();
        });
#endif
