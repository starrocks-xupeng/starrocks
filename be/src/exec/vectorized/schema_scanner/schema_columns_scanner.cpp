...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/schema_scanner/schema_columns_scanner.cpp
...
Status SchemaColumnsScanner::fill_one_row(ChunkPtr* chunk) {
    // TABLE_CATALOG
    {
...
Status SchemaColumnsScanner::get_next_row(ChunkPtr* chunk, bool* eos) {
    if (!_is_init) {
