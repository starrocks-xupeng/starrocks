...
//   https://github.com/apache/incubator-doris/blob/master/be/src/exec/schema_scanner/schema_dummy_scanner.cpp
...
Status SchemaDummyScanner::get_next_row(ChunkPtr* chunk, bool* eos) {
    *eos = true;
    return Status::OK();
}
