...
static const std::string file_tag_type_key = "type";
static const std::string file_tag_type_data = "data";
static const std::string file_tag_type_meta = "meta";
    ...
    StatusOr<std::unique_ptr<WritableFile>> new_writable_file(const WritableFileOptions& opts,
        ...
        if (config::starlet_write_file_with_tag) {
            if (lake::is_segment(pair.first)) {
                fslib_opts.tags[file_tag_type_key] = file_tag_type_data;
            } else {
                fslib_opts.tags[file_tag_type_key] = file_tag_type_meta;
            }
        }
